...
export function SalesBank() {
  ...
  const {
    ...
    deleteSale,
    isUpdating,
  } = useSales(selectedMonth, 'BankTransfer')
  ...
  const handleExport = () => {
    ...
    exportSalesToCSV(sales, 'bank')
  }

  if (isLoading) {
    return <Loader size="lg" text="Loading bank transfer sales..." />
  }
    ...
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-center">
          ...
          <p className="text-gray-600">Failed to load bank transfer sales</p>
        </div>
      </div>
    )
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Bank Transfer Sales</h1>
              <p className="text-gray-600 mt-1">View all bank transfer transactions</p>
            </div>
          </div>
        </div>
        <Button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="card bg-blue-50 border-blue-200">
          ...
          <p className="text-2xl font-bold text-blue-900 mt-1">{sales.length}</p>
        </div>
        <div className="card bg-blue-50 border-blue-200">
